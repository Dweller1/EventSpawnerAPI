import { Controller, Post, Req, Res, HttpException, HttpStatus, UsePipes, Body, BadRequestException } from '@nestjs/common';
...
export class WebhookController {
  ...
  @Post()
  @UsePipes(
    new ZodValidationPipe([FacebookEventSchema, TiktokEventSchema])
  )
  async handleEvent(@Body() body: unknown) { // Use @Body() instead of @Req()
